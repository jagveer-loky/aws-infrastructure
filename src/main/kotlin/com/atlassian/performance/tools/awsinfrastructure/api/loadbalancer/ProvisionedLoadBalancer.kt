...
import com.atlassian.performance.tools.awsinfrastructure.api.network.access.NoopAccessRequester
import com.atlassian.performance.tools.awsinfrastructure.api.network.access.UnableAccessProvider
...
class ProvisionedLoadBalancer private constructor(
    ...
    object Defaults {
        ...
        val accessProvider: AccessProvider = UnableAccessProvider()
        val accessRequester: AccessRequester = NoopAccessRequester()
    }
